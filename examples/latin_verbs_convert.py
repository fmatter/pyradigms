...
import re
import numpy as np
cols = ["Verb_Form", "Mood", "Tense", "Aspect", "Voice", "Person", "Number", "Case", "Gender"]
...
latin["Verb_Form"].replace({"VERB:Fin": "FIN",
"VERB:Inf": "INF",
"VERB:Ger": "GER",
"VERB:Gdv": "GDV",
"VERB:Part": "PTCP",
"VERB:Sup": "SUP"}, inplace=True)
latin["Mood"].replace({"Ind": "IND", "Sub": "SBJV", "Imp": "IMP"}, inplace=True)
latin["Tense"].replace({"Pres": "PRS", "Imp": "IMP", "Fut": "FUT", "Past": "PST", "Pqp": "PLUP"}, inplace=True)
...
latin.drop(axis=1, columns=["PoSTag:features", "freqTFTL", "freqAntiquitas", "freqAetasPatrum", "freqMediumAeuum", "freqRecentiorLatinitas", "form"], inplace=True)
